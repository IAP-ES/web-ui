      ...
      <div className="relative flex flex-col min-h-screen">
        ...
        <div className="relative flex-grow bg-black bg-opacity-50 flex flex-col items-center justify-center text-white">
          ...
          <div className="space-x-4 my-10">
            <Link to="https://703671939478-iap-es.auth.eu-north-1.amazoncognito.com/oauth2/authorize?client_id=2skfogn5co7ahodrti6ndqf7kt&response_type=code&scope=aws.cognito.signin.user.admin+email+openid+phone&redirect_uri=https%3A%2F%2Falb-1729041806.eu-north-1.elb.amazonaws.com%2Foauth2%2Fidpresponse">
